...
import 'package:abwabmaftoha/screens/Literary/Choise/ENS.dart';
import 'package:abwabmaftoha/screens/Literary/Choise/ES.dart';
import 'package:abwabmaftoha/screens/Literary/Choise/LMD1.dart';
import 'package:flutter/material.dart';
import 'package:font_awesome_flutter/font_awesome_flutter.dart';
import 'package:google_fonts/google_fonts.dart';

class LiteraryPage extends StatefulWidget {
  const LiteraryPage({super.key});

  @override
  State<LiteraryPage> createState() => _LiteraryPageState();
}
...
class _LiteraryPageState extends State<LiteraryPage> {
  @override
              ...
              child: Column(
                ...
                children: [
                  Image(
                    ...
                    image: const AssetImage('assets/image20.png')) ,
                   Text(
                    'مدارس عليا' ,
            ...
            child: Ink(
              child: Column(
                ...
                children: [
                  Image(
                    height: MediaQuery.sizeOf(context).height /5,
                    image: const AssetImage('assets/image26.png')) ,
                   Text(
            ...
            child: Ink(
              child: Column(
                ...
                children: [
                  Image(
                    height: MediaQuery.sizeOf(context).height /5,
                    image: const AssetImage('assets/image22.png')) ,
                   Text(
                    'مدارس عليا للأساتذة' ,
                      style: GoogleFonts.kufam(
                      color: Colors.black ,
    ...
    return Row(
      ...
      children: List.generate(_pageCount3, (index) {
        return AnimatedContainer(
          ...
          margin: const EdgeInsets.symmetric(horizontal: 5.0),
          height: 10.0,
          width: _currentPage2 % _pageCount3 == index ? 10.0 : 10.0,
          decoration: BoxDecoration(
            color: _currentPage2 % _pageCount3 == index ? const Color.fromARGB(255, 8, 141, 218) : Colors.grey,
            borderRadius: BorderRadius.circular(5.0),
          ),
        );
      }),
                              ...
                              Column(
                                ...
                                children: [
                                  Image(
                                    ...
                                    image: const AssetImage('assets/image12.png')
                                    ),
                                    SizedBox(
                          ...
                          Positioned(
                            ...
                            child:  Row(
                              ...
                              Image(
                                ...
                                image: const AssetImage('assets/image19.png'),
                                  ),
                                    ],
                                )), 
                        ],
                  ...
                  children: [
                    Column(
                            ...
                            children: [  
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  Image(
                                    height: MediaQuery.sizeOf(context).height / 15,
                                    image: const AssetImage('assets/image21.png')
                                    ),
                                    SizedBox(
                                      width: MediaQuery.sizeOf(context).width /20,
                                    ),
                          ...
                          Positioned(
                           ...
                           children: [
                           Image(
                              height: 0.37*MediaQuery.sizeOf(context).height,
                              image: const AssetImage('assets/image23.png'),
                              ),
                              ],
                          )),    
                  ],
